    ...
    blocks: [
      {
        ...
        restBetweenRounds: 0,
        steps: [
          { exerciseId: "jump_rope", sets: 1, duration: 60, restAfter: 10 },
          { exerciseId: "mountain_climbers", sets: 1, duration: 30, restAfter: 10 },
          { exerciseId: "plank", sets: 1, duration: 20, restAfter: 10 },
      ...
      },
      {
        ...
        steps: [
          { exerciseId: "pullups", sets: 1, reps: 5, restAfter: 20, note: "מקסימום חזרות נקיות" },
          { exerciseId: "negative_pullups", sets: 1, reps: 4, restAfter: 15, note: "ירידה איטית 3-5 שניות" },
      ...
      },
      {
        ...
        steps: [
          { exerciseId: "pushups", sets: 1, reps: 15, restAfter: 5 },
      ...
      },
      {
        ...
        steps: [
          { exerciseId: "trx_bicep_curls", sets: 1, reps: 12, restAfter: 5, note: "יד קדמית" },
      ...
      },
      {
        ...
        restBetweenRounds: 25,
        steps: [
          { exerciseId: "squats", sets: 1, reps: 20, restAfter: 5 },
      ...
      },
      {
        ...
        restBetweenRounds: 25,
        steps: [
          { exerciseId: "plank", sets: 1, duration: 60, restAfter: 5 },
          { exerciseId: "crunches_legs_up", sets: 1, reps: 20, restAfter: 5 },
          { exerciseId: "superman", sets: 1, duration: 20, restAfter: 5 },
          { exerciseId: "oblique_crunches", sets: 1, reps: 20, restAfter: 0 },
        ],
      },
    ],
  },
    ...
    blocks: [
      {
        ...
        steps: [
          { exerciseId: "jump_rope", sets: 1, duration: 60, restAfter: 10 },
          { exerciseId: "mountain_climbers", sets: 1, duration: 30, restAfter: 10 },
          { exerciseId: "glute_bridges", sets: 1, reps: 15, restAfter: 10 },
          { exerciseId: "squats", sets: 1, reps: 10, restAfter: 15 },
        ],
      },
      {
        type: "superset",
        ...
        restBetweenRounds: 35,
        steps: [
          { exerciseId: "jump_squats", sets: 1, reps: 15, restAfter: 5 },
      ...
      },
      {
        ...
        restBetweenRounds: 25,
        steps: [
          { exerciseId: "hip_thrusts", sets: 1, reps: 15, restAfter: 5, note: "גב עליון על ספסל/ספה – טווח גדול יותר מהגשר" },
          { exerciseId: "glute_bridges", sets: 1, reps: 20, restAfter: 5 },
      ...
      },
      {
        ...
        restBetweenRounds: 35,
        steps: [
          { exerciseId: "pushups", sets: 1, reps: 12, restAfter: 5 },
      ...
      },
      {
        ...
        restBetweenRounds: 25,
        steps: [
          { exerciseId: "mountain_climbers", sets: 1, duration: 30, restAfter: 5 },
          { exerciseId: "oblique_crunches", sets: 1, reps: 20, restAfter: 5 },
    ...
    blocks: [
      {
        ...
        steps: [
          { exerciseId: "jump_rope", sets: 1, duration: 60, restAfter: 10 },
          { exerciseId: "mountain_climbers", sets: 1, duration: 30, restAfter: 10 },
          { exerciseId: "pushups", sets: 1, reps: 8, restAfter: 10 },
          { exerciseId: "squats", sets: 1, reps: 10, restAfter: 15 },
        ],
      },
      {
        ...
        restBetweenRounds: 35,
        steps: [
          { exerciseId: "burpees", sets: 1, reps: 8, restAfter: 10 },
      ...
      },
      {
        ...
        restBetweenRounds: 35,
        steps: [
          { exerciseId: "pullups", sets: 1, reps: 6, restAfter: 10, note: "מקסימום חזרות" },
      ...
      },
      {
        ...
        restBetweenRounds: 35,
        steps: [
          { exerciseId: "jump_squats", sets: 1, reps: 12, restAfter: 5 },
      ...
      },
      {
        ...
        steps: [
          { exerciseId: "plank", sets: 1, duration: 60, restAfter: 5 },
          { exerciseId: "crunches_legs_up", sets: 1, reps: 20, restAfter: 0 },
        ],
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        restBetweenRounds: 35,
        steps: [
          { exerciseId: "pushups", sets: 1, reps: 16, restAfter: 5 },
    ...
    blocks: [
      {
        ...
        restBetweenRounds: 0,
        steps: [
          { exerciseId: "mountain_climbers", sets: 1, duration: 20, restAfter: 15 },
          { exerciseId: "squats", sets: 1, reps: 10, restAfter: 15 },
        ],
      },
      {
        ...
        steps: [
          { exerciseId: "pushups", sets: 1, reps: 8, restAfter: 15 },
          { exerciseId: "squats", sets: 1, reps: 15, restAfter: 15 },
          { exerciseId: "plank", sets: 1, duration: 30, restAfter: 15 },
          { exerciseId: "glute_bridges", sets: 1, reps: 15, restAfter: 15 },
          { exerciseId: "crunches_legs_up", sets: 1, reps: 15, restAfter: 0 },
        ],
      },
    ],
  },
